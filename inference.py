...
#song list importing
#happy
happymusic_dir='D:\\PE 2\\songs\\happy'
happysong = os.listdir(happymusic_dir)
#sad
sadmusic_dir='D:\\PE 2\\songs\\sad'
sadsong = os.listdir(sadmusic_dir)
#angry
angrymusic_dir='D:\\PE 2\\songs\\angry'
angrysong = os.listdir(angrymusic_dir)
#neutral
neutralmusic_dir='D:\\PE 2\\songs\\neutral'
neutralsong = os.listdir(neutralmusic_dir)
#rock
rockmusic_dir='D:\\PE 2\\songs\\rock'
rocksong = os.listdir(rockmusic_dir)
#surprise
surprisemusic_dir='D:\\PE 2\\songs\\surprise'
